...
Definition<br> Definition<br><br> Definition
:::
...
::: {.content-visible when-format="html"}
Example: 01.03.1942<br><br> [\[ 0 \]\[ 1 \]\[ 0 \]\[ 3 \]]{style="display: inline-block; width: 9ch; text-align: center;"}     [\[ 1 \]\[ 9 \]\[ 4 \]\[ 2 \]]{style="display: inline-block; width: 15ch; text-align: center;"}<br> [DayMonth]{style="display: inline-block; width: 9ch; text-align: center;"}     [Year]{style="display: inline-block; width: 15ch; text-align: center;"}
:::
...
::: {.content-visible when-format="pdf"}
\noindent This area should be approached with sensitivity. The recording of the response should not reflect what you believe may have occurred but rather what the person or the record indicates.
